...
use App\Http\Requests\SliderValidate as MainValidate;
...
class SliderController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->params['pagination']['totalItemsPerPage'] = 4; //Số phần tử trên 1 trang là 3, truyền params này vào model
    ...
    {
        $items = null;
        $title = " SliderController - Form - Add";
        
        if($request->id !== null)
        {
            $title = " SliderController - Form - Edit";
    ...
    public function save(MainValidate $request)
    {
        ...
        return redirect()->route('slider')->with('notify_action', $notify); //Tạo ra câu thông báo khi redirect xong
    }
    ...
    {   
        ...
        $this->model->deleteItems($this->params,['task' => 'delete-slider']);
        return redirect()->route('slider')->with('notify_action', 'Đã xóa thành công'); //Tạo ra câu thông báo khi redirect xong
    }
    ...
    {   
        ...
        return redirect()->route('slider')->with('notify_action', 'Đã cập nhật trạng thái thành công'); //Tạo ra câu thông báo khi redirect xong
    }
}