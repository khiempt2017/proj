...
<div class="right_col" role="main">
    ...
    @if ($items == null)
    <!--  Nếu không có dữ liệu thì show ra kiểu ko dữ liệu. $items là giá trị category controller trả về nếu có id trên URL-->
    <!--  ============================ Phần Add ============================-->
    <div class="page-header zvn-page-header clearfix">
        <div class="zvn-page-header-title">
            <h3>Slider - Form - Add</h3>
        </div>
    </div>
    <div class="x_content">
    ...
    <div class="page-header zvn-page-header clearfix">
        <div class="zvn-page-header-title">
            <h3>{{$controllerName}} - Form - Edit</h3>
        </div>
    </div>
    <div class="x_content">
        <form method="POST" action="{{$linkSave}}" accept-charset="UTF-8" enctype="multipart/form-data"
