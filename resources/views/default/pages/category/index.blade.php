...
@php
    ...
    $firstArticle       = $articlesInCategory[0];
    $id                 = $firstArticle->id;
    ...
    unset($articlesInCategory[0]); //Unset phần tử đầu tiên của mảng để phần đổ dữ liệu tiếp theo không đổ lại cái này nữa
@endphp
                ...
                <div class="row">
                    <div class="col">
                        <div class="home_content">
                            <div class="home_title">Những bài viết nằm trong chuyên mục: {{ $category_name }}</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="single_post">
                        ...
                        @foreach ($articlesInCategory as $key => $value)
                            @php
                                $id                 = $value->id;
                                $name               = $value->name;
