...
<a href="category/delete/12">Delete</a>
<a href="category/change-status-active/69">Status</a>
<a href="category/form/69">Edit</a>
<a href="category/form">Add</a> --}}
<?php 
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        @include('admin.pages.category.list')  <!-- Chứa phần đổ dữ liệu ra danh sách -->
