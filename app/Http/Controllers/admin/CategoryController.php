...
use App\Http\Requests\CategoryValidate as MainValidate;
...
class CategoryController extends Controller
{
    ...
    public function save(MainValidate $request)
    {
        ...
        return redirect()->route('category')->with('notify_action', $notify); //Tạo ra câu thông báo khi redirect xong
    }
    ...
    {   
        ...
        $this->model->deleteItems($this->params,['task' => 'delete-category']);
        return redirect()->route('category')->with('notify_action', 'Đã xóa thành công'); //Tạo ra câu thông báo khi redirect xong
    }
    ...
    {   
        ...
        return redirect()->route('category')->with('notify_action', 'Đã cập nhật trạng thái thành công'); //Tạo ra câu thông báo khi redirect xong
    }
    ...
    {   
        ...
        $this->model->saveItems($this->params,['task' => 'change-ishome-status']);
        
        return redirect()->route("category")->with('notify_action', 'Đã cập nhật trạng thái hiển thị ngoài trang chủ thành công'); //Tạo ra câu thông báo khi redirect xong
    }

    public function display(Request $request)
    {   
        $this->params['display']= $request->display;
        $this->params['id']     = $request->id;
        $this->model->saveItems($this->params,['task' => 'change-display-status']);
        
        return redirect()->route("category")->with('notify_action', 'Đã cập nhật kiểu hiển thị ngoài trang chủ thành công'); //Tạo ra câu thông báo khi redirect xong
    }
}