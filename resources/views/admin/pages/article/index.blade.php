                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                ...
                                                <li><a href="#"
                                                    class="select-field" data-my-field="description">Search by Description</a>
                                                </li>
                                                <li><a href="#"
                                                    class="select-field" data-my-field="link">Search by Link</a>
                                                </li>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        @include('admin.pages.article.list')  <!-- Chứa phần đổ dữ liệu ra danh sách -->
